...
<!-- Логотип з силкою на нашу сторінку  -->

<a class="header__logo" href="<?php echo get_home_url(); ?>">
<img class="header__logo-img" src="<?php $custom_logo_id = get_theme_mod( 'custom_logo' );
$image = wp_get_attachment_image_src( $custom_logo_id , 'full' );

// display it:
echo $image[0]; ?>" alt="Мир детства" >
