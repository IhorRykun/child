   ...
   echo get_template_directory_uri() . "/assets/img/not-found.jpg";
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- Змініюмо колір тексту в взалежності від повзунка в адмінці -->
                                    <h2 style="
                                    <?php
                                  ...
                                  <!-- Робимо силку на сторінку при активній кнопці -->
                                  ...
                                  <?php
                                    ...
                                    if($field =="on") {
                                     ?>
                                       <a href="<?php the_field("slider_link")?>" class="button">Взнати більше</a>
                                     <?php
                                    }
                                    ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                      ...
                      <?php the_field("section_serch_text") ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
